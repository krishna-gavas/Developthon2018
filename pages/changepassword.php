                    ...
                    <section class="content">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Enter the current and new passwords</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                            <form action="updatepassword.php" onsubmit="return validate()" method="POST">
                                <div class="box-body">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                    <div class="form-group col-xs-4">
                                            <label for="password1">Enter the new password</label>
...
//To check enetered passwords are same or not
    function validate()
    {
