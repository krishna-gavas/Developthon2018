  ...
  if(isset($_SESSION['email']) && isset($_SESSION['logged_in']))
  {
      /*if($_SESSION['username']!='admin')
      {
        ...
        header('Refresh:0;url=home.php');
	  	  ...
	  	  $id=$_GET['id'];
	  $query1="select * from medical_info where id='$id'";
...
<li><a href="update_medi2.php?id=<?php echo $id; ?>">medical record2</a></li>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="form-group col-xs-4">
                                            ...
                                            <input type="number" class="form-control " readonly value="<?php echo $row['id'] ?>" name="id">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control "  value="<?php echo $row['hb'] ?>" name="hb">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-8">
                                            ...
                                            <input type="text" class="form-control "  value="<?php echo $row['bp'] ?>" name="bp">
                                        </div>
                                    </div>
                                    <div class="row">
									<div class="form-group col-xs-4">
                                            <label for="weight">Weight</label>
                                            <input type="number" class="form-control "  value="<?php echo $row['weight'] ?>" name="weight">
                                        </div>
                                        ...
                                        <div class="col-md-3 form-group">
                                            ...
                                            <select name="urine" value="<?php echo $row['urine_test'] ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="date" name="fd" value="<?php echo $row['first_scan'] ?>"  />
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="date" name="sd" value="<?php echo $row['sec_scan'] ?>" />
