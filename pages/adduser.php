                    ...
                    <section class="content">
                        ...
                        <div class="box box-primary">
                            <div class="box-header with-border">
                                <h3 class="box-title">Enter the details of the new Users</h3>
                            </div>
                            <!-- /.box-header -->
                            <!-- form start -->
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="form-group col-xs-4">
                                            <label for="userno">Users ID</label>
                                            <input type="number" required class="form-control " name="userno" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="photo" accept="image/*" name="photo" capture="camera"  />
                                    </div>
...
<option value="Hosur">Hosur</option>            
									...
									<div class="row">
                                        <div class="form-group col-xs-4">
                                            ...
                                            <input type="number" class="form-control " name="phone" pattern="[789][0-9]{9}" />
                                        </div>
                                    </div>
